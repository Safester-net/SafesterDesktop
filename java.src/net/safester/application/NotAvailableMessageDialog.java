 ...
 */
public class NotAvailableMessageDialog extends javax.swing.JDialog {

    private MessagesManager messages = new MessagesManager();
    private Connection connection = null;
    Frame parent;
    private boolean messageServiceOn = false;
    /** The hash value of the content (text) of the message */
    private String hashContent = null;

    public NotAvailableMessageDialog(java.awt.Frame parent, Connection theConnection) throws Exception {
        super(parent);
        initComponents();
     ...
     */
    private String getHtmlContent() throws IOException, MalformedURLException {
        String content = null;
        ...
        try {
            ...
            URL url = new URL(host + "/newstart/not_available_message.html");
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    NotAvailableMessageDialog dialog = null;
                    
                    dialog = new NotAvailableMessageDialog(new javax.swing.JFrame(), connection);
                    ...
                    Logger.getLogger(NotAvailableMessageDialog.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
