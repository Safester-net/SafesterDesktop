...
import net.safester.application.compose.api.IncomingMessageDTOBuilder;
 ...
 *
 */
public class ApiMessageTestDataCreator {
     ...
     * 
     */
    public ApiMessageTestDataCreator() {
    ...
    public IncomingMessageDTO incomingMssageDTOBuild()
	...
	List<File> enuncryptedFiles = getEnuncryptedFiles();
    ...
    public List<File> getEnuncryptedFiles() {
