...
public class BuyDialog extends javax.swing.JDialog {
    ...
    public BuyDialog(java.awt.Frame parent, Connection theConnection, int usernumber, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        }
    ...
    {
        String content = HtmlTextUtil.getHtmlHelpContent("buy_dialog_start");
        ...
        try
        {
            ...
            URL url = new URL(host + "/TableBuyV3Display");
    ...
    private void initComponents() {
        ...
        jPanelSepBottom1.setMaximumSize(new java.awt.Dimension(32767, 8));
        jPanelSepBottom1.setMinimumSize(new java.awt.Dimension(10, 8));
        jPanelSepBottom1.setPreferredSize(new java.awt.Dimension(10, 8));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                BuyDialog dialog = new BuyDialog(new javax.swing.JFrame(), connection, (short)1, true);
