...
/**
 * Works a JOptionPane.showMessageDialog(), but allows to pass a message with
 * HTML fomrat and and clickable URL
 *
...
public class JOptionPaneHtml {
     ...
     * the <code>parentComponent</code> has no <code>Frame</code>, a      * default <code>Frame</code> is used
