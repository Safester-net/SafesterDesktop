...
public class ButtonResizer
{
     ...
     */
    public void setWidthToMax(List<Component> components)
    {        
        int buttonWidth = 0;
        ...
        for (int i = 0; i < components.size(); i++)
        {
            ...
            {                
                ...
                currentButton.setMinimumSize(new Dimension(maxButtonWidth, height));
                currentButton.setSize(new Dimension(maxButtonWidth, height));
